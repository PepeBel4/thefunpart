...
export class TranslationService {
  ...
  private readonly translations: TranslationDictionary = {
    en: {
      ...
      'admin.sections.options': 'Menu item options',
      'admin.options.heading': 'Menu item options',
      'admin.options.description': 'Create optional add-ons and extras for your dishes.',
      'admin.options.selectItem': 'Choose menu item',
      'admin.options.loading': 'Loading options…',
      'admin.options.emptyMenu': 'Create a menu item before adding options.',
      'admin.options.empty': 'No options yet.',
      'admin.options.new.heading': 'Add new option',
      'admin.options.form.name': 'Option name',
      'admin.options.form.price': 'Price',
      'admin.options.create': 'Add option',
      'admin.options.saving': 'Saving…',
      'admin.options.save': 'Save changes',
      'admin.options.cancel': 'Cancel',
      'admin.options.edit': 'Edit',
      'admin.options.remove': 'Remove',
      'admin.options.removing': 'Removing…',
      'admin.options.status.created': 'Option added!',
      'admin.options.status.updated': 'Option updated!',
      'admin.options.status.deleted': 'Option removed.',
      'admin.options.error.load': 'Unable to load menu item options. Please try again.',
      'admin.options.error.create': 'Unable to add the option. Please try again.',
      'admin.options.error.update': 'Unable to update the option. Please try again.',
      'admin.options.error.delete': 'Unable to remove the option. Please try again.',
      'admin.options.error.price': 'Enter a valid price (e.g. 0.50).',
      'admin.options.removeConfirm': 'Remove this option?',
      'admin.options.noRestaurant': 'Select a restaurant to manage menu item options.',
    ...
    nl: {
      ...
      'admin.sections.options': 'Opties voor menu-items',
      'admin.options.heading': 'Opties voor menu-items',
      'admin.options.description': 'Maak extra\'s en aanvullingen aan voor je gerechten.',
      'admin.options.selectItem': 'Kies menu-item',
      'admin.options.loading': 'Opties laden…',
      'admin.options.emptyMenu': 'Maak eerst een menu-item aan voordat je opties toevoegt.',
      'admin.options.empty': 'Nog geen opties.',
      'admin.options.new.heading': 'Nieuwe optie toevoegen',
      'admin.options.form.name': 'Naam van de optie',
      'admin.options.form.price': 'Prijs',
      'admin.options.create': 'Optie toevoegen',
      'admin.options.saving': 'Opslaan…',
      'admin.options.save': 'Wijzigingen opslaan',
      'admin.options.cancel': 'Annuleren',
      'admin.options.edit': 'Bewerken',
      'admin.options.remove': 'Verwijderen',
      'admin.options.removing': 'Verwijderen…',
      'admin.options.status.created': 'Optie toegevoegd!',
      'admin.options.status.updated': 'Optie bijgewerkt!',
      'admin.options.status.deleted': 'Optie verwijderd.',
      'admin.options.error.load': 'Opties konden niet worden geladen. Probeer het opnieuw.',
      'admin.options.error.create': 'De optie kon niet worden toegevoegd. Probeer het opnieuw.',
      'admin.options.error.update': 'De optie kon niet worden bijgewerkt. Probeer het opnieuw.',
      'admin.options.error.delete': 'De optie kon niet worden verwijderd. Probeer het opnieuw.',
      'admin.options.error.price': 'Voer een geldige prijs in (bijv. 0,50).',
      'admin.options.removeConfirm': 'Deze optie verwijderen?',
      'admin.options.noRestaurant': 'Selecteer een restaurant om de opties te beheren.',
    ...
    fr: {
      ...
      'admin.sections.options': 'Options du menu',
      'admin.options.heading': 'Options du menu',
      'admin.options.description': 'Créez des suppléments et options pour vos plats.',
      'admin.options.selectItem': 'Choisir un plat',
      'admin.options.loading': 'Chargement des options…',
      'admin.options.emptyMenu': 'Créez un plat avant d’ajouter des options.',
      'admin.options.empty': 'Aucune option pour le moment.',
      'admin.options.new.heading': 'Ajouter une option',
      'admin.options.form.name': 'Nom de l’option',
      'admin.options.form.price': 'Prix',
      'admin.options.create': 'Ajouter l’option',
      'admin.options.saving': 'Enregistrement…',
      'admin.options.save': 'Enregistrer les modifications',
      'admin.options.cancel': 'Annuler',
      'admin.options.edit': 'Modifier',
      'admin.options.remove': 'Supprimer',
      'admin.options.removing': 'Suppression…',
      'admin.options.status.created': 'Option ajoutée !',
      'admin.options.status.updated': 'Option mise à jour !',
      'admin.options.status.deleted': 'Option supprimée.',
      'admin.options.error.load': 'Impossible de charger les options. Veuillez réessayer.',
      'admin.options.error.create': 'Impossible d’ajouter l’option. Veuillez réessayer.',
      'admin.options.error.update': 'Impossible de mettre à jour l’option. Veuillez réessayer.',
      'admin.options.error.delete': 'Impossible de supprimer l’option. Veuillez réessayer.',
      'admin.options.error.price': 'Saisissez un prix valide (ex. 0,50).',
      'admin.options.removeConfirm': 'Supprimer cette option ?',
      'admin.options.noRestaurant': 'Sélectionnez un restaurant pour gérer les options.',
    ...
    de: {
      ...
      'admin.sections.options': 'Menüoptionen',
      'admin.options.heading': 'Optionen für Gerichte',
      'admin.options.description': 'Erstelle Zusatzoptionen und Extras für deine Gerichte.',
      'admin.options.selectItem': 'Gericht auswählen',
      'admin.options.loading': 'Optionen werden geladen…',
      'admin.options.emptyMenu': 'Lege zuerst ein Gericht an, bevor du Optionen hinzufügst.',
      'admin.options.empty': 'Noch keine Optionen.',
      'admin.options.new.heading': 'Neue Option hinzufügen',
      'admin.options.form.name': 'Name der Option',
      'admin.options.form.price': 'Preis',
      'admin.options.create': 'Option hinzufügen',
      'admin.options.saving': 'Speichern…',
      'admin.options.save': 'Änderungen speichern',
      'admin.options.cancel': 'Abbrechen',
      'admin.options.edit': 'Bearbeiten',
      'admin.options.remove': 'Entfernen',
      'admin.options.removing': 'Wird entfernt…',
      'admin.options.status.created': 'Option hinzugefügt!',
      'admin.options.status.updated': 'Option aktualisiert!',
      'admin.options.status.deleted': 'Option entfernt.',
      'admin.options.error.load': 'Optionen konnten nicht geladen werden. Bitte versuche es erneut.',
      'admin.options.error.create': 'Option konnte nicht hinzugefügt werden. Bitte versuche es erneut.',
      'admin.options.error.update': 'Option konnte nicht aktualisiert werden. Bitte versuche es erneut.',
      'admin.options.error.delete': 'Option konnte nicht entfernt werden. Bitte versuche es erneut.',
      'admin.options.error.price': 'Gib einen gültigen Preis ein (z. B. 0,50).',
      'admin.options.removeConfirm': 'Diese Option entfernen?',
      'admin.options.noRestaurant': 'Wähle ein Restaurant, um Optionen zu verwalten.',
