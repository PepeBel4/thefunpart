...
export class TranslationService {
  ...
  private readonly translations: TranslationDictionary = {
    en: {
      ...
      'menu.options.error.price': 'Enter a valid price (e.g. 1.50).',
      'menu.options.form.nameLabel': 'Option name',
      'menu.options.form.priceLabel': 'Price (EUR)',
      'menu.options.form.descriptionLabel': 'Description',
      'menu.options.form.pricePlaceholder': 'e.g. 1.50',
      'menu.options.form.descriptionPlaceholder': 'Optional description',
    ...
    nl: {
      ...
      'menu.options.error.price': 'Voer een geldig bedrag in (bijv. 1,50).',
      'menu.options.form.nameLabel': 'Naam van de optie',
      'menu.options.form.priceLabel': 'Prijs (EUR)',
      'menu.options.form.descriptionLabel': 'Beschrijving',
      'menu.options.form.pricePlaceholder': 'bijv. 1,50',
      'menu.options.form.descriptionPlaceholder': 'Optionele beschrijving',
    ...
    fr: {
      ...
      'menu.options.error.price': 'Indiquez un prix valide (ex. 1,50).',
      'menu.options.form.nameLabel': 'Nom de l’option',
      'menu.options.form.priceLabel': 'Prix (EUR)',
      'menu.options.form.descriptionLabel': 'Description',
      'menu.options.form.pricePlaceholder': 'ex. 1,50',
      'menu.options.form.descriptionPlaceholder': 'Description facultative',
    ...
    de: {
      ...
      'menu.options.error.price': 'Gib einen gültigen Preis ein (z. B. 1,50).',
      'menu.options.form.nameLabel': 'Name der Option',
      'menu.options.form.priceLabel': 'Preis (EUR)',
      'menu.options.form.descriptionLabel': 'Beschreibung',
      'menu.options.form.pricePlaceholder': 'z. B. 1,50',
      'menu.options.form.descriptionPlaceholder': 'Optionale Beschreibung',
