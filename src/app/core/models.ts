...
export interface SalesPipelineTimeframe {
  start_date: string;
  end_date: string;
}

export interface SalesPipelineTotals {
  orders: number;
...
export interface SalesPipelineStatusProgression {
  status: string;
  order_count: number;
}
...
export interface SalesPipelineDailyTotals {
  date: string;
  order_count: number;
  revenue_cents: number;
}
